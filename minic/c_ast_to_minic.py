...
def transform(x):
    return {
        ...
        c_ast.If: (lambda orig: mc.If(transform(orig.cond), transform(orig.iftrue), transform(orig.iffalse), coord=orig.coord)),
        ...
        c_ast.While: (lambda orig: mc.While(transform(orig.cond), transform(orig.stmt), coord=orig.coord)),
